...
import NotPublish from "@iconify-icons/ri/close-line";
// import Reset from "@iconify-icons/ri/restart-line";
import More2Fill from "@iconify-icons/ri/more-2-fill";
import Publish from "@iconify-icons/ri/check-line";
import ExpandIcon from "./svg/expand.svg?component";
import UnExpandIcon from "./svg/unexpand.svg?component";
import Branch from "@iconify-icons/ri/git-branch-line";
...
defineExpose({ onTreeReset, sethighlight });
</script>
        ...
        <template #default="{ node, data }">
          ...
          >
            <IconifyIconOffline
              ...
              "
            />
            <span class="!w-[120px] !truncate" :name="node.label">
              {{ node.label }}
            </span>
          </div>
        </template>
